...
model = model_from_json(open("C:\\Users\\bharg\\Downloads\\facedl.json", "r").read())
model.load_weights('C:\\Users\\bharg\\Downloads\\facedl.h5')

# Load Haarcascade for face detection
face_cascade = cv2.CascadeClassifier('C:\\Users\\bharg\\OneDrive\\Desktop\\emotion\\haarcascade_frontalface_default1.xml')
